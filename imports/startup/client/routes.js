...
Router.map(function () {
  this.route('home', function () {
    this.render('siriusHome');
    this.layout('siriusLayout');
  });
  this.route('sirius-member-list', function () {
    this.render('siriusMemberList');
    this.layout('siriusLayout');
  });
  this.route('/membercode/:code', function () {
    this.render('siriusMemberDetails', {
      data: {
        memberCode: Number(this.params.code)
      }
    });
    this.layout('siriusLayout');
  });
...
//sirius
Router.map(function () {
  this.route('sirius-new-member', function () {
    this.render('siriusnewmember');
  });
  this.route('sirius-member-list-admin', function () {
    this.render('siriusMemberListAdmin');
  })
});